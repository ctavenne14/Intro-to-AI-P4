...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        for x in features:
          qValue += features[x] * self.getWeights()[x]
    ...
    def update(self, state, action, nextState, reward):
        ...
        for x in features:
          self.weights[x] = self.weights[x] + self.alpha * features[x] * ((reward + self.discount * self.computeValueFromQValues(nextState)) - self.getQValue(state, action))
